       ...
       try {
            ...
            button.setOnAction((ActionEvent e) -> {
                ...
                try {
                    ...
                    Cipher cipher = Cipher.getInstance("AES");//AES is encryption algorithm
                    // encrypt the text
                    cipher.init(Cipher.ENCRYPT_MODE, aesKey);//initiailize cipher takes cipher operation mode and key
                    byte[] encrypted = cipher.doFinal(message.getBytes());//do final takes array of bytes
